...
// --- Datos Estáticos y Animaciones (Mejora de Limpieza y Rendimiento) ---

// 1. Variantes de Framer Motion reutilizables
...
// 2. Datos de la lista de la Primera Sección (para evitar el split innecesario en el render)
const routeItems = [
...
export default function HomePage() {
  return (
    <>
      ...
      {/* 2. SECCIÓN QUIÉN SOY */}
      <motion.section
        variants={slideInFromLeft} // Usamos la variante definida
        initial="initial"
        whileInView="animate"
        viewport={{ once: true }}
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left space-y-6">
          ...
          <div className="bg-verdes text-amarillo p-6 ">
            <p className="text-lg md:text-xl">
              ...
              <br />
              <br />
              Hablarte de mí es fácil si te digo que soy como un Paquete
              Microsoft Office.
            </p>
          </div>
      ...
      {/* 3. SECCIÓN METAS / PASOS */}
      <motion.section
        variants={slideInFromRight} // Usamos la variante definida
        initial="initial"
        whileInView="animate"
        viewport={{ once: true }}
      ...
      >
        ...
        <div className="w-full lg:w-1/2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-4 text-center">
          {/* Uso de datos pre-formateados (goalsItems) */}
          {goalsItems.map((item, index) => (
            // Uso de index como key es aceptable si la lista no cambia de orden
            <div
              key={index}
      ...
      {/* 4. SECCIÓN PODCAST */}
      <motion.section
        variants={fadeInFromBottom} // Usamos la variante definida
        initial="initial"
        whileInView="animate"
        viewport={{ once: true }}
      ...
      >
        ...
        <div className="w-full md:w-[40%] lg:w-[50%] flex flex-col items-center md:items-start">
          <article className="text-center md:text-left space-y-4">
            ...
            <p className="text-lg text-amarillo">
              Enfocado en crear mensajes VIP, que aportan VALOR para tu
              audiencia, los INSPIRAN a pasar a la acción y tienen PROPÓSITO.
            </p>
            <p className="text-lg text-amarillo">
              {
